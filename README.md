...
This respository is cloned into your local project folder during the `tapestry init` command. This respository supplies a cloudformation template that provisions AWS resources needed to run Airbyte, our selected data ingestion tool.
